...
if (umur >= 17)
    ...
    console.log("umur belum cukup untuk buat KTP");
...
if (fName == "jordan" && lName == "sumardi")
    console.log("jordan sumardi");
else
    console.log("nama lengkap bukan jordan sumardi");
// || (or) menggabungkan 2/lebih kondisi. dimana salah 1 dari kondisi wajib true
if (fName == "jordan" || lName == "sumardi")
    console.log("namanya antara jordan atau sumardi");
else
    console.log("nama bukan jordan atau sumardi");
if (!(lName == "sumardi"))
    console.log("last name bukan sumardi");
